...
item replace entity @p hotbar.2 with bow{Unbreakable:1,Enchantments:[{id:"power",lvl:5},{id:"punch",lvl:1},{id:"flame",lvl:1}]}
item replace entity @p container.29 with minecraft:arrow 20
item replace entity @p hotbar.3 with minecraft:golden_carrot 10